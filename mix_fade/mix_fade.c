...
void module_init(void) {
  ...
  // adc0 is set to max
  // adc1 is set to min as defined in params.c
...
void module_process_frame(void) { 
  ...
  //--- dynamicaly adjust amp volume from inside the program using
  //    the faderValue variable
