...
//wrapper variable for my filter 
static fract32 filtWrapper = 0;
...
void module_init(void) {
  ...
  param_setup(eParam_myFilt, 0);

  //set up my_svf (monosynth.c)
...
void module_process_frame(void) { 
  ...
  */
  ...
  filtWrapper = filter_svf_lpf_next(&my_svf, in[0]);
