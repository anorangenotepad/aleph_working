...
extern void fill_param_desc(ParamDesc* desc) {
  ...
  //control value for rilter cutoff
  //tried copying CV first, and worked, but had high-freq self-osc type sound
  //
  strcpy(desc[eParam_myFilt].label, "myFilt");
  desc[eParam_myFilt].type = eParamTypeFix; 
  desc[eParam_myFilt].min = 0x00000000; 
  desc[eParam_myFilt].max = PARAM_CV_MAX ;
  desc[eParam_myFilt].radix = 16; // full-scale 16.16
