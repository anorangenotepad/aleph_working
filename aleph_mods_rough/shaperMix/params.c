...
extern void fill_param_desc(ParamDesc* desc) {
  ...
  strcpy(desc[eParam_wShapeAdd].label, "wShapeAdd");
  desc[eParam_wShapeAdd].type = eParamTypeFix;
  desc[eParam_wShapeAdd].min = 0x00000000; 
  desc[eParam_wShapeAdd].max = PARAM_CV_MAX;
  desc[eParam_wShapeAdd].radix = 16;

  //this is the extra one so i can manipulate the
  //top and bottom of waveform seperately
  strcpy(desc[eParam_wShapeSub].label, "wShapeSub");
  desc[eParam_wShapeSub].type = eParamTypeFix;
  desc[eParam_wShapeSub].min = 0x00000000; 
  desc[eParam_wShapeSub].max = PARAM_CV_MAX;
  desc[eParam_wShapeSub].radix = 16;
