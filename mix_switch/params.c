...
extern void fill_param_desc(ParamDesc* desc) {
  ...
  //my set of four bool switches 
  //- one for each channel
  //- zero offset to match other sets (above)

  strcpy(desc[eParam_chanSwitch0].label, "chanSwitch0");
  desc[eParam_chanSwitch0].type = eParamTypeBool; 
  desc[eParam_chanSwitch0].min = 0; 
  desc[eParam_chanSwitch0].max = 1;
  desc[eParam_chanSwitch0].radix = 2;

  strcpy(desc[eParam_chanSwitch1].label, "chanSwitch1");
  desc[eParam_chanSwitch1].type = eParamTypeBool; 
  desc[eParam_chanSwitch1].min = 0; 
  desc[eParam_chanSwitch1].max = 1;
  desc[eParam_chanSwitch1].radix = 2;

  strcpy(desc[eParam_chanSwitch2].label, "chanSwitch2");
  desc[eParam_chanSwitch2].type = eParamTypeBool; 
  desc[eParam_chanSwitch2].min = 0; 
  desc[eParam_chanSwitch2].max = 1;
  desc[eParam_chanSwitch2].radix = 2;

  strcpy(desc[eParam_chanSwitch3].label, "chanSwitch3");
  desc[eParam_chanSwitch3].type = eParamTypeBool; 
  desc[eParam_chanSwitch3].min = 0; 
  desc[eParam_chanSwitch3].max = 1;
  desc[eParam_chanSwitch3].radix = 2;
