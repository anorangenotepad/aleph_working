...
static fract32 chanSwitch0 = 0;
static fract32 chanSwitch1 = 0;
static fract32 chanSwitch2 = 0;
static fract32 chanSwitch3 = 0;
...
void module_init(void) {
  ...
  //channel switches
  param_setup(eParam_chanSwitch0, 0 );
  param_setup(eParam_chanSwitch1, 0 );
  param_setup(eParam_chanSwitch2, 0 );
  param_setup(eParam_chanSwitch3, 0 );
...
void module_process_frame(void) { 
  ...
  */
  // scale each input and add it to the busi
  // no bus for this one, but leaving code in
  /*
  ...
  */
  ...
  // each out is an individual out. no master

  if (chanSwitch0 == 1)
  {
    out[0] = mult_fr1x32x32(in[0], adcVal[0]); 
  }

  else if (chanSwitch0 == 0)
  {
    out[0] = 0;
  }
  ...
  if (chanSwitch1 == 1)
  {
    out[1] = mult_fr1x32x32(in[1], adcVal[1]);
  }
  
  else if (chanSwitch1 == 0)
  {
    out[1] = 0;
  }
  ...
  if (chanSwitch2 == 1)
  {
    out[2] = mult_fr1x32x32(in[2], adcVal[2]);
  }

  else if (chanSwitch2 == 0)
  {
    out[2] = 0;
  }
  ...
  if (chanSwitch3 == 1)
  {
    out[3] = mult_fr1x32x32(in[3], adcVal[3]);
  }

  else if (chanSwitch3 == 0)
  {
    out[3] = 0;
  }
...
void module_set_param(u32 idx, ParamValue v) {
  ...
  case eParam_chanSwitch0 :
    chanSwitch0 = v;
    break;
  case eParam_chanSwitch1 :
    chanSwitch1 = v;
    break;
  case eParam_chanSwitch2 :
    chanSwitch2 = v;
    break;
  case eParam_chanSwitch3 :
    chanSwitch3 = v;
    break;
