...
extern void fill_param_desc(ParamDesc* desc) {
  ...
  desc[eParam_sinHz0].type = eParamTypeNote;
  desc[eParam_sinHz0].min = 0x00010000;      // 1 hz (multi_voice/params.h)
  desc[eParam_sinHz0].max = 0x40000000;    // 16384 hz
  desc[eParam_sinHz0].radix = 15;
  ...
  */
  ...
  desc[eParam_sinTune0].min = 0x4000;     // 1/4(multi_voice/params.h) 
  desc[eParam_sinTune0].max = 0x40000;    // 4
  desc[eParam_sinTune0].radix = 3;
